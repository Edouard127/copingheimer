...
func init() {
	...
	flag.StringVar(&Arguments.Mode, "m", "order", "Mode to run in (default: \"order\") (random, order)")
	flag.StringVar(&Arguments.Mode, "mode", "order", "Mode to run in (default: \"order\") (random, order)")
